...
void NotificationController::sendAnnouncement(const std::string& title,
    ...
    msg["title"] = title;
    msg["content"] = content;
    msg["announcement_id"] = announcement_id;
    msg["level"] = level;
    ...
    APP_LOG_INFO("Announcement broadcast to {} users: {}", connections_.size(), title);
}
